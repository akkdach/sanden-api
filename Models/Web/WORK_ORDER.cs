...
namespace BevProFSServiceAPI.Models.Entity
{
    public class WORK_ORDER
    {
        ...
        [ForeignKey("MN_WK_CTR")]
        public WORK_CENTER MAIN_WORK_CENTER { get; set; }
        ...
        [MaxLength(20)]
        public string ERROR_SENT_TO_NAV { get; set; }

        public List<WORK_ORDER_OPERATION> OPERATIONS { get; set; }
        public List<WORK_ORDER_COMPONENT> COMPONENTS { get; set; }
        public WORK_ORDER_CUSTOMER_MAS CUSTOMER_MAS { get; set; }
        public WORK_ORDER_NOTIFICATION_HEADER NOTIFICATION_HEADER { get; set; }
        public List<WORK_ORDER_HISTORYORDER_HEADER> HISTORYORDER_HEADER { get; set; }
        public List<WORK_ORDER_HISTORY_SPAREPART> HISTORY_SPAREPART { get; set; }


        [MaxLength(255)]
        public string URLIMAGEQC_1 { get; set; }

        [MaxLength(255)]
        public string URLIMAGEQC_2 { get; set; }

        [MaxLength(255)]
        public string URLIMAGEQC_3 { get; set; }

        [MaxLength(255)]
        public string URLIMAGEQC_4 { get; set; }
        [MaxLength(20)]
